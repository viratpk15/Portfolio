...
export default function AnimatedMesh() {
          ...
          <svg width="100%" height="100%" preserveAspectRatio="xMidYMid slice">
            <defs>
              <linearGradient id="mesh-grad-1" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stopColor="#D4A574" stopOpacity="0.02" />
                <stop offset="100%" stopColor="transparent" />
              </linearGradient>
              <radialGradient id="mesh-radial-1" cx="0.3" cy="0.3" r="0.7">
                <stop offset="0%" stopColor="#E8C97A" stopOpacity="0.03" />
                <stop offset="100%" stopColor="transparent" />
              </radialGradient>
  ...
  return (
    <div 
      ...
      style={{ zIndex: "var(--z-background-gradient)" }}
    >
      {/* Large radial gradients for ambient breathing - viewport constrained */}
