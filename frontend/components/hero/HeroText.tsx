...
export default function HeroText() {
  return (
    <div className="relative flex flex-col">
      ...
      <div className="pointer-events-none absolute -left-10 -top-20 h-80 w-80 rounded-full bg-[var(--color-primary)]/5 blur-[100px]" />
      ...
      >
        ...
        <motion.div 
          ...
          variants={item}
        >
          <span className="opacity-90">Driven by Curiosity</span>
          <span className="text-[var(--color-primary)]">·</span>
          <span className="opacity-90">Built with Discipline</span>
          <span className="text-[var(--color-primary)]">·</span>
          <span className="opacity-90">Defined by Consistency</span>
        </motion.div>

        {/* Main Hero Heading - Largest typography */}
        <motion.h1
        ...
        >
          ...
          <p className="max-w-xl text-lg leading-7 text-[var(--color-text-tertiary)]">
            {profile.headline}
          </p>
        </motion.div>
        ...
        <motion.p
          className="max-w-xl text-base leading-7 text-[var(--color-text-tertiary)]"
          variants={item}
        >
          {profile.subtitle}
        </motion.p>
